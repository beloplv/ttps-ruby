...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference("Turn.count") do
      post turns_url, params: { turn: { date: @turn.date, hour: @turn.hour, motive: @turn.motive, result: @turn.result, status: @turn.status } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { date: @turn.date, hour: @turn.hour, motive: @turn.motive, result: @turn.result, status: @turn.status } }
