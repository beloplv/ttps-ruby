...
class BranchOfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch_office" do
    assert_difference("BranchOffice.count") do
      post branch_offices_url, params: { branch_office: { address: @branch_office.address, name: @branch_office.name, phone: @branch_office.phone } }
    end
  ...
  test "should update branch_office" do
    patch branch_office_url(@branch_office), params: { branch_office: { address: @branch_office.address, name: @branch_office.name, phone: @branch_office.phone } }
